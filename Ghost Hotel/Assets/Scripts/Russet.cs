...
public class Russet : MonoBehaviour {
	...
	public Queue<bool> memorialdirections = new Queue<bool> (new[] {false, false, false, false, false, true, false, true, false, true, true, true, false, true, true, false, true, false, false, true, false, false, false, false, true, false, false, true, false, false});
	...
	void Update () {
		...
		memorialdirections = new Queue<bool> (new[] {false, false, false, false, false, true, false, true, false, true, true, true, false, true, true, false, true, false, false, true, false, false, false, false, true, false, false, true, false, false});
